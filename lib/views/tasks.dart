              ...
              children: snapshot.data!.docs.map((DocumentSnapshot document) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    title: Text(data['taskName'] ?? 'No name'),
                    subtitle: Text(data['taskDesc'] ?? 'No name'),
                    isThreeLine: true,
                        ...
                        return [
                          PopupMenuItem(
                            ...
                            onTap: () {
                              ...
                              DateTime taskDate = data['taskDate'].toDate();
                              Future.delayed(
                          ...
                          PopupMenuItem(
                            ...
                            onTap: () {
                              String taskId = (data['id'] ?? 'No name');
                              String taskName = (data['taskName'] ?? 'No name');
                              Future.delayed(
                                const Duration(seconds: 0),
                                () => showDialog(
                                  context: context,
